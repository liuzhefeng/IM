...
import com.im.ui.view.chat.data.GroupsData;
import com.im.ui.view.chat.data.RemindCount;
import com.im.ui.view.chat.data.TalkData;
import com.im.ui.view.chat.element.group_bar_chat.ElementInfoBox;
...
public class ChatController extends ChatInit implements IChatMethod {
    ...
    public void setUserInfo(String userId, String userNickName, String userHead) {
        ...
        button.setStyle(String.format("-fx-background-image: url('/com/im/ui/chat/img/head/%s.png')", userHead));
    }
